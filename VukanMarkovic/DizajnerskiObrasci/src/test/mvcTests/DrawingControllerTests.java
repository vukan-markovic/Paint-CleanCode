...
public class DrawingControllerTests {
	...
	public void setUp() throws AWTException {
		...
		strategy = mock(StrategyManager.class);
		robot = new Robot();
	}
...
//		verify(controllerMock).fireEvents();
	...
	public void testSaveDrawing() throws IOException {
		...
		verify(strategy).setStrategy(savePainting);
		verify(strategy).save(fileChooser.getSelectedFile().getAbsolutePath() + "\\" + file.getName());
	}
	...
	public void testSaveLog() throws IOException {
		...
		verify(strategy).setStrategy(saveLog);
		verify(strategy).save(fileChooser.getSelectedFile().getAbsolutePath() + "\\" + file.getName());
	}
